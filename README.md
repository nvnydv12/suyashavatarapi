...
```text
http://127.0.0.1:5000/profile-image?server=IND&uid=6950878222&key=suyash
```
...
4. In **Project Settings > Environment Variables**, add:
	...
	```text
	API_KEY=suyash
	INFO_API_URL=https://suyashprofileapi.vercel.app/profile
	INFO_SERVER=IND
	```
...
5. Deploy, then use the deployed URL:
	...
	```text
	https://YOUR-PROJECT.vercel.app/profile-image?server=IND&uid=6950878222&key=suyash
	```
